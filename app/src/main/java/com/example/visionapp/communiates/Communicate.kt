...
enum class CommunicateType(val message: String, val priority: Int, val category: CommunicateCategory) {
    ...
    CROSSING("Warning, you are entering a crossing", 4, CommunicateCategory.CROSSING),
    ...
    NO_PEDESTRIANS("Warning, you are forbidden to enter this area", 2, CommunicateCategory.SIGNS),
    PEDESTRIANS_TO_THE_LEFT("Warning, pedestrians should go on the left", 7, CommunicateCategory.SIGNS),
    PEDESTRIANS_TO_THE_RIGHT("Warning, pedestrians should go on the right", 7, CommunicateCategory.SIGNS),
    ...
    WARNING_ROAD("Warning, you are entering a road", 6, CommunicateCategory.PASSAGE),
    WARNING_BIKE_PATH("Warning, you are entering a bike path", 6, CommunicateCategory.PASSAGE),
